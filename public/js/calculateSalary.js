...
module.exports= calculateSalary = (body)=>{ //월급계산
    ...
    console.log(basePay);
    return (parseInt(foodExpenses)+parseInt(transportationCost))*numberOfWeekDay + basePay;
  }

  let calculateBasePay= (eslistmentDay,calculateMonth)=>{ //기본급 계산!
